  ...
  return (
    <Html lang="en">
      ...
      <body>
        ...
        <div id="xx"></div>
        <Script type='x-shader/x-vertex' id="shader-vertex-terrain-perlinsombrero" strategy="afterInteractive">
{`
vec3 mod289(vec3 x)
{
...
`}
        ...
        <Script type="x-shader/x-fragment" id="shader-fragment-terrain" strategy="afterInteractive">
          {`
                    varying vec2 v_uv;
                    varying vec3 v_line_color;
                    varying float z;
        ...
        <Script src='/anim.js' strategy="afterInteractive"></Script>
      </body>
    </Html>
  )
}
